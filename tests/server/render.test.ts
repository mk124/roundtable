...
test('a javascript: link is never a clickable link (AE13)', () => {
...
test('a non-allowlisted scheme degrades to a non-link span (AE13)', () => {
...
test('images render as alt text with no img element or URL (R28)', () => {
...
test('raw HTML becomes literal text, never structure (AE13)', () => {
